...
- openshifttest-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- openshifttest-ui: main application module, development time
- openshifttest-production: module that produces a production mode WAR for deployment
